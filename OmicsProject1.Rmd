...
# try a PCA
```{r}
df_PCA <- data.frame(t(omicsdata)[, -1], subset(annotations, select = c(clinical_group, lesional, sample_group)))
PCA_AD <- PCA(df_PCA, quali.sup = which(names(df_PCA) %in% c("clinical_group", "lesional", "sample_group"))) 
